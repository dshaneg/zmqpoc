...
namespace Interrupt
{
    ...
    {
        // I don't really see the point of this exercise in c# console apps. Ctrl-C works just fine without this code.
        // perhaps when handling the stop signal in a windows service?
